...
import zipfile
import processFromZip # local file, TODO look into possibly making it a part of the package

# this doesn't appear to ever get called. Excluding from final api
def print_on_rank0(msg):
    if torch.distributed.get_rank() == 0:
        print(msg)

## Initialize all variables and begin training
def init(configs, config_yaml_path, exp_group_name, exp_name, perform_validation):
    ## use configs to initialize system variables
    ...
    ## store some configs in variables for easy access
...
if __name__ == "__main__":
    ...
    init(config_yaml, config_yaml_path, exp_group_name, exp_name, perform_validation)
